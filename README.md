...
| [3Sum](https://github.com/smilevideo/algorithms/blob/master/algorithms/3sum.js) | Given an array of numbers, find three distinct array values whose sum is x. | <ul><li>Two different approaches with the same space and time complexities:</li><li>First algorithm: Two-pointer approach</li><li>Second algorithm: Hashing approach</li></ul> | O(n<sup>2</sup>) | O(n) |
